...
For simplicity and ease of setup, we provisioned and packaged a VM with OWL already installed and setup. Below are detailed step on how to retrieve the VM and test out the _**OWL**_ application.
